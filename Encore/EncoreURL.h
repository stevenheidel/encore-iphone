...
//User's concerts
static NSString *const UserConcertsURL = @BASE_URL_DEF "users/%@/events.json"; //,facebook id
...
static NSString *const SingleConcertURL = @BASE_URL_DEF "events/%@.json";
...
//Posts
static NSString *const ConcertPostsURL = @BASE_URL_DEF "events/%@/posts.json" ; //,concertID
static NSString *const FlagPostURL = @"posts/%@/flag.json"; //,postID
//Concert Check
static NSString *const CheckConcertOnProfileURL = @"users/%@/check_events.json"; //,userID
...
static NSString* const PostImageURL = @"events/%@/posts.json"; //,concertid
...
#pragma mark - Friends
static NSString* const SaveFriendsURL = @BASE_URL_DEF "users/%@/events/%@/add_facebook_friends.json"; //,userID,eventID
static NSString* const GetFriendsURL = @BASE_URL_DEF "users/%@/events/%@/facebook_friends.json"; //
